...
public class SaleService : ISaleService
{
    ...
    public SaleService(ISaleRepository saleRepository, IOrderRepository orderRepository, IProductRepository productRepository, ICustomerRepository customerRepository, IOrderProductRepository orderProductRepository, IRequestRepository requestRepository = null)
    {
    ...
    {
        var order = await _orderProductRepository.GetAsync(x => x.Id == id);
        if (order == null)
        {
